...
#
RPT_LIST="${SANITY_RPT} ${INVALID_MARKER_RPT} ${SEC_MARKER_RPT} ${INVALID_TERMID_RPT} ${INVALID_JNUM_RPT} ${INVALID_EVID_RPT} ${INVALID_EDITOR_RPT}  ${MULTIPLE_MCV_RPT} ${MKR_TYPE_CONFLICT_RPT} ${BEFORE_AFTER_RPT} ${RPT_NAMES_RPT}"
